...
const paddingLeft = 'padding-left: 4vh';
...
export default ({
  teamName, username, channels, users, onChannelAddClick
}) => (
    <ChannelWrapper>
      <PushLeft>
        <PushDown>
      ...
      <div>
        <SideBarList>
          <SideBarListHeader>Channels <Icon onClick={onChannelAddClick} name="add circle"/> </SideBarListHeader>
